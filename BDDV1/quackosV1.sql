/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     21/06/2016 18:32:51                          */
/*==============================================================*/
...
alter table CURSO add constraint FK_RELATIONSHIP_6 foreign key (IDESTUDIANTE)
      references ESTUDIANTE (IDESTUDIANTE) on delete restrict on update restrict;

alter table CURSO add constraint FK_RELATIONSHIP_7 foreign key (IDPROFESOR)
...
alter table PROFESOR add constraint FK_RELATIONSHIP_8 foreign key (IDPERSONA)
      references PERSONA (IDPERSONA) on delete restrict on update restrict;
